...
class Neighbor {
  ...
  static async find(id) {
    const query = `SELECT * FROM neighbors WHERE id = ?`;
  ...
  static async findByUsername(username) {
    const query = `SELECT * FROM neighbors WHERE username = ?`;
  ...
  static async create(username, password) {
    ...
    const query = `INSERT INTO neighbors (username, password_hash)
      VALUES (?, ?) RETURNING *`;
